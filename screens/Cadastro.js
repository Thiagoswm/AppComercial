    ...
    <View style={styleFormat.container}>
      ...
      {/*Área do cadastro de usuário */}
        <View style={styleFormat.cxinput}>
          <TextInput style={styleFormat.input}
          ...
          <TextInput style={styleFormat.input}
          placeholder="Senha"
          value={senha} keyboardType="default"
          secureTextEntry
      ...
      {/*Fim da área de cadastro de usuário */}
      ...
      {/*Área do cadastro do endereço */}
        ...
        <TextInput style={styleFormat.input}
          ...
          value={logradouro} keyboardType="default"
        ...
        <TextInput style={styleFormat.input}
          ...
          value={complemento} keyboardType="default"
          onChangeText={(value)=>setComplemento(value)}
          />

        <TextInput style={styleFormat.input}
          placeholder="Bairro"
          value={bairro} keyboardType="default"
